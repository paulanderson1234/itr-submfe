...
import controllers.eisseis.NewProductController
...
class NewProductSpec extends ViewSpec {
  ...
  "Verify that the NewProduct page contains the correct elements " +
    ...
    document.body.getElementById("back-link").attr("href") shouldEqual controllers.eisseis.routes.NewGeographicalMarketController.show().url
