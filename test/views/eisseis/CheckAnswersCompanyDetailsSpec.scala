...
class CheckAnswersCompanyDetailsSpec extends CheckAnswersSpec {
  ...
  "Verify that the scheme description contains only SEIS and EIS when schemeTypesModel.eisseis == true" in {
    ...
    val page = CheckAnswers(model, SchemeTypesModel(seis = true, eis = true))(fakeRequest, applicationMessages)
    ...
    "Verify that the scheme description contains EIS /SEIS and VCT when schemeTypesModel.eisseis == true and schemeTypesModel.vct == true" in {
      val model = CheckAnswersModel(None, None, None, None, None, None, None, None, None, None, None, None, Vector(), None, None, None, None, None, None, None, None, None, None, false)
      val page = CheckAnswers(model, SchemeTypesModel(seis = true, eis = true, vct = true))(fakeRequest, applicationMessages)
