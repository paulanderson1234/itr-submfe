...
import models.submission.{Submission, SubmissionResponse}
import models.{ContactDetailsModel, YourCompanyNeedModel}
...
import scala.concurrent.Future
  ...
  class AcknowledgementSpec extends UnitSpec with WithFakeApplication with Mockito with FakeRequestHelper with SubmissionFixture{
