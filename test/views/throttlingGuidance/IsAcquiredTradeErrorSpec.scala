...
import views.html.throttlingGuidance.IsAcquiredTradeError


class IsAcquiredTradeErrorSpec  extends ViewSpec {

  "The user limit reached page" should {

    "contain the correct elements when loaded" in {

      lazy val page = IsAcquiredTradeError()(fakeRequest, applicationMessages)
      ...
      document.body.getElementById("throttle-reason").text() shouldEqual Messages("page.throttlingGuidance.isAcquiredTradeError.reason")
      ...
      document.body.getElementById("change-link").attr("href") shouldEqual controllers.eligibility.routes.AcquiredTradeEligibilityController.show().url
