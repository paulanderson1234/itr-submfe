...
import views.html.throttlingGuidance.IsAgentError


class IsAgentErrorSpec extends ViewSpec {

  "The user limit reached page" should {

    "contain the correct elements when loaded" in {

      lazy val page = IsAgentError()(fakeRequest, applicationMessages)
      ...
      document.body.getElementById("throttle-reason").text() shouldEqual Messages("page.throttlingGuidance.isAgentError.reason")
      ...
      document.body.getElementById("change-info").text() shouldEqual Messages("page.throttlingGuidance.isAgentError.notAgent") +
