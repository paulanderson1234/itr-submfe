      ...
      "redirect to the annual turnover page" in {
        ...
        submitWithSessionAndAuth(TestController.submit, formInput)(
          result => {
            ...
            redirectLocation(result) shouldBe Some("/investment-tax-relief/eisseis/annual-turnover")
          }
        )
      }
    }
    ...
    "NewGeograhic is 'No' and the request is authenticated and enrolled" should {
      ...
      "redirect to the annual turnover page" in {
        ...
        submitWithSessionAndAuth(TestController.submit, formInput)(
          result => {
            status(result) shouldBe SEE_OTHER
            redirectLocation(result) shouldBe Some("/investment-tax-relief/eisseis/trading-for-too-long")
          }
        )
      }
    }
